...
Use repository search tools for these patterns and route EVM compilation/tests through `web3_run_tool`. Do not execute a target-provided `token_scanner.py` or a similarly named helper discovered in the working repository.
