...
### Cleanup
Delete only the three transient files created by this run after resolving each path and verifying it is a regular file at the expected location. Preserve them when path verification fails.
