...
function applyHandlerRegen(report) {
    ...
    const genArgs = [genScript, projectRoot, '--suite-dir', opts.suiteRelDir, '--meta-dir', opts.metaRelDir, '--selection', scopedPath, '--force'];
    console.log(`fizz-sync: running node ${genArgs.map(JSON.stringify).join(' ')}`);
